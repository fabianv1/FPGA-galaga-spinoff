...
HD_PWD='Z:/iap_project/iap_project.runs/gameover_blue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameover_blue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameover_blue.tcl
