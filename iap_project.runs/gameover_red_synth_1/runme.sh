...
HD_PWD='Z:/iap_project/iap_project.runs/gameover_red_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameover_red.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameover_red.tcl
