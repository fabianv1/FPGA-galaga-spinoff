...
HD_PWD='Z:/iap_project/iap_project.runs/instructions_grey_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instructions_grey.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instructions_grey.tcl
