...
HD_PWD='Z:/iap_project/iap_project.runs/gameover_green_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameover_green.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameover_green.tcl
