...
HD_PWD='Z:/iap_project/iap_project.runs/banner_green_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log banner_green.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source banner_green.tcl
