...
HD_PWD='Z:/iap_project/iap_project.runs/banner_blue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log banner_blue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source banner_blue.tcl
