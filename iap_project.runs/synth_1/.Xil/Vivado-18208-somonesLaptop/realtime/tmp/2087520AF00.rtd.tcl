...
set genomeRtd $env(RT_TMP)/2087520AF00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_level_GT0__2}]"
...
set genomeName [subst -nocommands -novariables {top_level_GT0__2}]
