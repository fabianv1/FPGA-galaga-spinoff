...
set genomeRtd $env(RT_TMP)/175DA0D8560.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_level_GT1}]"
...
set genomeName [subst -nocommands -novariables {top_level_GT1}]
