...
set genomeRtd $env(RT_TMP)/224BD7FA060.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gameplay_screen__GB5}]"
...
set genomeName [subst -nocommands -novariables {gameplay_screen__GB5}]
