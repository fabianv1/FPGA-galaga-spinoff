...
set genomeRtd $env(RT_TMP)/1CB2FE70D00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_level_GT0}]"
...
set genomeName [subst -nocommands -novariables {top_level_GT0}]
