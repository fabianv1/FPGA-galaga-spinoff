...
set genomeRtd $env(RT_TMP)/2092E382BA0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gameplay_screen__GB19}]"
...
set genomeName [subst -nocommands -novariables {gameplay_screen__GB19}]
