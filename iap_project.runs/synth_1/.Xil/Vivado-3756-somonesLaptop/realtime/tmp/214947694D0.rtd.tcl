...
set genomeRtd $env(RT_TMP)/214947694D0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {partition__216_top_level__GD}]"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList Z:/Labs/iap_project/iap_project.runs/synth_1/.Xil/Vivado-3756-somonesLaptop/realtime/top_level_synth.xdc; 
set genomeName [subst -nocommands -novariables {partition__216_top_level__GD}]
