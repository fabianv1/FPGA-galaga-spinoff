...
set genomeRtd $env(RT_TMP)/1F60CB182D0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gameplay_screen__GB6}]"
...
set genomeName [subst -nocommands -novariables {gameplay_screen__GB6}]
