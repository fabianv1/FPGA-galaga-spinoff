...
set genomeRtd $env(RT_TMP)/1B446C92070.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gameplay_screen__GB9}]"
...
set genomeName [subst -nocommands -novariables {gameplay_screen__GB9}]
