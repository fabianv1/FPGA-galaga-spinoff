...
HD_PWD='Z:/iap_project/iap_project.runs/instructions_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instructions_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instructions_map.tcl
