...
HD_PWD='Z:/iap_project/iap_project.runs/grey_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grey_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grey_map.tcl
