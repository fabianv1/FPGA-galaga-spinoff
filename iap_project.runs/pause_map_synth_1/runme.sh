...
HD_PWD='Z:/iap_project/iap_project.runs/pause_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pause_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pause_map.tcl
