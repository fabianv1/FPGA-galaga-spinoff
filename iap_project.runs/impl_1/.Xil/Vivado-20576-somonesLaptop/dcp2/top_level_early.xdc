set_property SRC_FILE_INFO {cfile:z:/Labs/iap_project/iap_project.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.xdc rfile:../../iap_project.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.xdc id:1 order:EARLY scoped_inst:clk_divider/inst rxprname:$PSRCDIR/sources_1/ip/clk_wiz_0_1/clk_wiz_0.xdc} [current_design]
set_property src_info {type:PI file:{} line:-1 export:NONE save:INPUT read:READ} [current_design]
set_property TOOL_DERIVED_CLK_NAMES 1:0:CLKIN1:CLKFBOUT:clk_100mhz:clkfbout_clk_wiz_0::1:0:CLKIN1:CLKOUT0:clk_100mhz:clk_out1_clk_wiz_0::1:0:CLKIN1:CLKFBOUT:sys_clk_pin:clkfbout_clk_wiz_0_1::1:0:CLKIN1:CLKOUT0:sys_clk_pin:clk_out1_clk_wiz_0_1 [get_cells clk_divider/inst/mmcm_adv_inst]
