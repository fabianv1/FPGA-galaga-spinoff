...
HD_PWD='Z:/iap_project/iap_project.runs/buttons_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buttons_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buttons_map.tcl
