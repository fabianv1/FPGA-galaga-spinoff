...
#
# Generated by export_simulation on Fri Jan 28 19:04:26 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './gameover_green.sh' script.

./gameover_green.sh -reset_run
...
./gameover_green.sh -noclean_files

For more information on the script, please type './gameover_green.sh -help'.
