...
#
# Generated by export_simulation on Fri Jan 28 18:42:14 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './banner_blue.sh' script.

./banner_blue.sh -reset_run
...
./banner_blue.sh -noclean_files

For more information on the script, please type './banner_blue.sh -help'.
