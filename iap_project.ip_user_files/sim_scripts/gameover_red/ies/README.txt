...
#
# Generated by export_simulation on Fri Jan 28 19:02:07 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './gameover_red.sh' script.

./gameover_red.sh -reset_run
...
./gameover_red.sh -noclean_files

For more information on the script, please type './gameover_red.sh -help'.
