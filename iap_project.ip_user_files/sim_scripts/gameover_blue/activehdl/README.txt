...
#
# Generated by export_simulation on Fri Jan 28 19:07:09 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './gameover_blue.sh' script.

./gameover_blue.sh -reset_run
...
./gameover_blue.sh -noclean_files

For more information on the script, please type './gameover_blue.sh -help'.
