...
#
# Generated by export_simulation on Fri Jan 28 18:58:42 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './pause_rom.sh' script.

./pause_rom.sh -reset_run
...
./pause_rom.sh -noclean_files

For more information on the script, please type './pause_rom.sh -help'.
