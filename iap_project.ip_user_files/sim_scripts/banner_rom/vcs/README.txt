...
#
# Generated by export_simulation on Fri Jan 28 18:43:05 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './banner_rom.sh' script.

./banner_rom.sh -reset_run
...
./banner_rom.sh -noclean_files

For more information on the script, please type './banner_rom.sh -help'.
