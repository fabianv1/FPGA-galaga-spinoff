...
#
# Generated by export_simulation on Fri Jan 28 18:50:05 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './grey_map.sh' script.

./grey_map.sh -reset_run
...
./grey_map.sh -noclean_files

For more information on the script, please type './grey_map.sh -help'.
