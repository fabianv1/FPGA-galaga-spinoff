...
#
# Generated by export_simulation on Fri Jan 28 18:56:36 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './buttons_rom.sh' script.

./buttons_rom.sh -reset_run
...
./buttons_rom.sh -noclean_files

For more information on the script, please type './buttons_rom.sh -help'.
