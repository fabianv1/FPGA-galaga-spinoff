...
#
# Generated by export_simulation on Fri Jan 28 18:44:19 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './banner_green.sh' script.

./banner_green.sh -reset_run
...
./banner_green.sh -noclean_files

For more information on the script, please type './banner_green.sh -help'.
