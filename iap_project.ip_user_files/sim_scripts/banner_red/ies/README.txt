...
#
# Generated by export_simulation on Fri Jan 28 18:43:43 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './banner_red.sh' script.

./banner_red.sh -reset_run
...
./banner_red.sh -noclean_files

For more information on the script, please type './banner_red.sh -help'.
